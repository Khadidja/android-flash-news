...
public class NotificationUtils {
    ...
    private String LOG_TAG = NotificationUtils.class.getSimpleName();
    ...
    public void showNotificationMessage(String title, String message, Intent intent) {
        ...
        if (appIsInBackground(mContext)) {
            Log.d(LOG_TAG, "App running in background");
            int icon = R.mipmap.ic_launcher;

            int mNotificationId = FlashNewsApplication.NOTIFICATION_ID;
    ...
    private static boolean appIsInBackground(Context context) {
